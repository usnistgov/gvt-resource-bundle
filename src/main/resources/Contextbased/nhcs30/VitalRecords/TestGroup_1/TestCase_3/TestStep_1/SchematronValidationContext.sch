...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern id="PATIENT-DEMOGRAPHICS" name="PATIENT-DEMOGRAPHICS">
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole">
            <assert test="cda:patient/cda:administrativeGenderCode[@code]"
                >Patient Sex Must exist</assert>
        ...
        <rule
            ...
            <assert
                test="cda:entry/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.36' and @extension = '2016-12-01']]/cda:value/@value"
                >
                Age at time of death must exist</assert>
...
-->
            <assert
                test="count(cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.6' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.16' and @extension = '2016-12-01']]) >= 2"
                >Causes of Death MUST exist</assert>            

            <assert
                test="cda:entry/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.12' and @extension = '2016-12-01']]/cda:value[@code = 'PHC1261']"
                >Pregnancy status must be PHC1261</assert>
...
<!--            
    ...
    <pattern id="DEATH-ADMIN" name="DEATH-ADMIN">
        <rule
            ...
            <assert test="cda:entry/cda:act[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.7' and @extension = '2016-12-01']]/cda:performer/cda:assignedEntity/cda:code[@code='440051000124108']"
                >Certifier type SHALL be 440051000124108</assert>
    ...
    <pattern id="EXISTENCE-CHECKS" name="EXISTENCE-CHECKS">
        <rule context="/cda:ClinicalDocument">
            ...
            <assert
                ...
                >Patient Given names autSHALL exist</assert>            
            <assert

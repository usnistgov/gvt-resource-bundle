...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern id="PATIENT-DEMOGRAPHICS" name="PATIENT-DEMOGRAPHICS">
        <rule context="/cda:ClinicalDocument/cda:recordTarget/cda:patientRole">
            <assert test="cda:patient/cda:administrativeGenderCode[@code]">Patient Sex Must
                exist</assert>
...
<!--        
    ...
    -->                    
            ...
            <assert
                ...
                >Death Result From Injury must be 'Y'</assert>
            
            
            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.41' and @extension = '2016-12-01']]/cda:value[@code = 'N']"
                >Death Result From Injury at work must be 'N'</assert>
            
            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.34' and @extension = '2016-12-01']]/cda:value[@code = 'Y']"
                >Injury leading to death assocated with transportation event must be 'Y'</assert>
            
            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.33' and @extension = '2016-12-01']]"
                >Injury details must exist</assert>

            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.34' and @extension = '2016-12-01']]/cda:participant/cda:participantRole/cda:code[@code='236320001']"
                >Transportation role must be 236320001</assert>

            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.33' and @extension = '2016-12-01']]/cda:participant/cda:participantRole/cda:playingEntity/cda:code[@code='4']"
                >Injury location must be '4'</assert>
            
            <assert
                test="cda:entry/cda:organizer[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.9' and @extension = '2016-12-01']]/cda:component/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3.33' and @extension = '2016-12-01']]/cda:participant/cda:participantRole/cda:addr/*"
                >Injury location narrative must exist</assert>
    ...
    <pattern id="DEATH-ADMIN" name="DEATH-ADMIN">
        <rule
            ...
            <assert test="cda:entry/cda:procedure[@negationInd='true'][cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.2' and @extension = '2016-12-01']]"
                >Autopsy Indicator must indicate an autopsy does not exist</assert>
<!--            
            <assert test="cda:entry/cda:procedure[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.2' and @extension = '2016-12-01']]/cda:entryRelationship/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.3' and @extension = '2016-12-01']]/cda:value[@value = 'true']"
                >Results available must be true</assert>
    ...
    <pattern id="DEATH-EVENT" name="DEATH-EVENT">
        <rule
            ...
            <assert
                test="cda:entry/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.26.1.11']]/cda:value[@code = '7878000']"
                >Manner of death must be 7878000</assert>
